...
@section('pageTitle', 'Bookmark list')
...
@section('content')
    ...
    <section class="movies">
        ...
        <h2 class="section-heading" style="text-align: center"> Your Favorite Movies </h2>


        <!-- Movies Grid -->
        <div class="movies-grid" id="featured-movies">

            @foreach(Movies::getAllBookmarkedMovies(Auth::user()->id) as $featuredMovie)
